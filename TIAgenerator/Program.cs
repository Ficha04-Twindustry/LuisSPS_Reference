...
namespace TIAgenerator
{
    internal class MAIN
    {
...

        {
            ...
            TIA_V15_1 newTIA = new TIA_V15_1();
            XML_Handling XML_Handler = new XML_Handling();
            ...
            else if (prjCreateOpen == "test")
            {
                XML_Handler.OpenXML("C:/Users/Twindustry/Desktop/tttt.xml");
                result = false;
            }
                if (result)
            {
                PlcDevice plc001 = newTIA.NewPlcDevice();
                Console.Write("PLC Block to be found: ");
                string plcBlockName = Console.ReadLine();
                Console.Write("exporting");
                plc001.ExportXML(plcBlockName);
                Console.Write("DONE");
                Console.Read();
